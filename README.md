...
- 📌 [Oodle AI](https://oodle.ai) (`Oodle`) Agent observability platform with agent traces, logs, evals, datasets and prompt management. Works with [OpenTelemetry GenAI Semantic Conventions](https://github.com/open-telemetry/semantic-conventions-genai).
